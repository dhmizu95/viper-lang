// N-body Simulation Benchmark - Rust Implementation
...
fn bodies() -> [Body; N_BODIES] {
    [
        // sun:
        Body { x: F64x4::new(0., 0., 0., 0.), v: F64x4::new(0., 0., 0., 0.), mass: SOLAR_MASS },
        // jupiter:
        Body {
            x: F64x4::new(
