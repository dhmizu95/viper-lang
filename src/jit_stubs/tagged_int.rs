...
use crate::jit_stubs::bigint::{
    vp_bigint_add_stub, vp_bigint_cmp_stub, vp_bigint_div_stub, vp_bigint_eq_stub,
    vp_bigint_free_stub, vp_bigint_from_i64_stub, vp_bigint_gt_stub, vp_bigint_lt_stub,
    vp_bigint_mod_stub, vp_bigint_mul_stub, vp_bigint_neg_stub, vp_bigint_pow_stub,
    vp_bigint_sub_stub, vp_bigint_to_i64_stub, vp_bigint_to_str_stub,
};
...
pub extern "C" fn tagged_int_bitand(lhs: i64, rhs: i64) -> i64 {
    ...
    let res_ptr = unsafe { crate::jit_stubs::bigint::vp_bigint_from_i64_temp_stub(0) };
    unsafe {
        crate::jit_stubs::bigint::vp_bigint_and_stub(
            res_ptr as *mut _,
            l_ptr as *mut _,
            r_ptr as *mut _,
        )
...
pub extern "C" fn tagged_int_bitor(lhs: i64, rhs: i64) -> i64 {
    ...
    let res_ptr = unsafe { crate::jit_stubs::bigint::vp_bigint_from_i64_temp_stub(0) };
    unsafe {
        crate::jit_stubs::bigint::vp_bigint_or_stub(
            res_ptr as *mut _,
            l_ptr as *mut _,
            r_ptr as *mut _,
        )
...
pub extern "C" fn tagged_int_bitxor(lhs: i64, rhs: i64) -> i64 {
    ...
    let res_ptr = unsafe { crate::jit_stubs::bigint::vp_bigint_from_i64_temp_stub(0) };
    unsafe {
        crate::jit_stubs::bigint::vp_bigint_xor_stub(
            res_ptr as *mut _,
            l_ptr as *mut _,
            r_ptr as *mut _,
        )
...
pub extern "C" fn tagged_int_lshift(lhs: i64, rhs: i64) -> i64 {
    ...
    if !is_bigint(lhs) && !is_bigint(rhs) {
        ...
        if b < 0 || b >= 63 {
            ...
            let res_ptr = unsafe { crate::jit_stubs::bigint::vp_bigint_from_i64_temp_stub(0) };
            unsafe {
                crate::jit_stubs::bigint::vp_bigint_lshift_stub(
                    res_ptr as *mut _,
                    l_ptr as *mut _,
                    r_ptr as *mut _,
                )
...
pub extern "C" fn tagged_int_rshift(lhs: i64, rhs: i64) -> i64 {
    ...
    let res_ptr = unsafe { crate::jit_stubs::bigint::vp_bigint_from_i64_temp_stub(0) };
    unsafe {
        crate::jit_stubs::bigint::vp_bigint_rshift_stub(
            res_ptr as *mut _,
            l_ptr as *mut _,
            r_ptr as *mut _,
        )
