...
#[no_mangle]
pub extern "C" fn vp_http_response_header(resp: *mut std::ffi::c_void, name: *const i8) -> *mut i8 {
...
pub extern "C" fn vp_http_response_free(resp: *mut std::ffi::c_void) {
    if !resp.is_null() {
        unsafe {
            drop(Box::from_raw(resp as *mut HttpResponse));
        }
    }
}
...
// Server
#[no_mangle]
pub extern "C" fn vp_http_server_create(
    port: i64,
    handler_fn: *mut std::ffi::c_void,
) -> *mut std::ffi::c_void {
    let _ = port;
    let _ = handler_fn;
    std::ptr::null_mut()
...
#[no_mangle]
pub extern "C" fn vp_http_ok() -> i64 {
    200
}

#[no_mangle]
pub extern "C" fn vp_http_created() -> i64 {
    201
}

#[no_mangle]
pub extern "C" fn vp_http_no_content() -> i64 {
    204
}

#[no_mangle]
pub extern "C" fn vp_http_moved_permanently() -> i64 {
    301
}

#[no_mangle]
pub extern "C" fn vp_http_found() -> i64 {
    302
}

#[no_mangle]
pub extern "C" fn vp_http_not_modified() -> i64 {
    304
}

#[no_mangle]
pub extern "C" fn vp_http_bad_request() -> i64 {
    400
}

#[no_mangle]
pub extern "C" fn vp_http_unauthorized() -> i64 {
    401
}

#[no_mangle]
pub extern "C" fn vp_http_forbidden() -> i64 {
    403
}

#[no_mangle]
pub extern "C" fn vp_http_not_found() -> i64 {
    404
}

#[no_mangle]
pub extern "C" fn vp_http_method_not_allowed() -> i64 {
    405
}

#[no_mangle]
pub extern "C" fn vp_http_conflict() -> i64 {
    409
}

#[no_mangle]
pub extern "C" fn vp_http_internal_server_error() -> i64 {
    500
}

#[no_mangle]
pub extern "C" fn vp_http_not_implemented() -> i64 {
    501
}

#[no_mangle]
pub extern "C" fn vp_http_bad_gateway() -> i64 {
    502
}

#[no_mangle]
pub extern "C" fn vp_http_service_unavailable() -> i64 {
    503
}
