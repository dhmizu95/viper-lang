...
use crate::parser::statements::core::StatementParser;
use crate::parser::statements::{parse_expression, parse_type_annotation};
...
pub fn parse_primary_expr(parser: &mut StatementParser) -> Result<Expr, String> {
    ...
    let expr = match kind {
        TokenKind::Int(n) => {
            parser.advance();
            crate::parser::statements::primary::literals::parse_int_literal(parser, n, span)
        }
        TokenKind::BigInt(s) => {
            parser.advance();
            crate::parser::statements::primary::literals::parse_bigint_literal(parser, s, span)
        }
        TokenKind::Float(n) => {
            parser.advance();
            crate::parser::statements::primary::literals::parse_float_literal(parser, n, span)
        }
        TokenKind::Str(s) => {
            parser.advance();
            crate::parser::statements::primary::literals::parse_str_literal(parser, s, span)
        }
        TokenKind::FString(s) => {
            parser.advance();
            crate::parser::statements::primary::literals::parse_fstring_literal(parser, s, span)
        }
        TokenKind::Bytes(b) => {
            parser.advance();
            crate::parser::statements::primary::literals::parse_bytes_literal(parser, b, span)
        }
        TokenKind::Bool(b) => {
            parser.advance();
            crate::parser::statements::primary::literals::parse_bool_literal(parser, b, span)
        }
        TokenKind::True => {
            parser.advance();
            crate::parser::statements::primary::literals::parse_bool_literal(parser, true, span)
        }
        TokenKind::False => {
            parser.advance();
            crate::parser::statements::primary::literals::parse_bool_literal(parser, false, span)
        }
        TokenKind::None => {
            parser.advance();
            crate::parser::statements::primary::literals::parse_none_literal(parser, span)
        }
        TokenKind::Super => {
            parser.advance();
            crate::parser::statements::primary::literals::parse_super_expr(parser, span)
        }
        TokenKind::Await => {
            parser.advance();
        ...
        TokenKind::Send => {
            return crate::parser::statements::primary::calls::parse_send_expr(parser, span);
        }
        TokenKind::Recv => {
        ...
        TokenKind::Not => {
            return crate::parser::statements::primary::operators::parse_not_expr(parser, span);
        }
        TokenKind::Tilde => {
            return crate::parser::statements::primary::operators::parse_invert_expr(parser, span);
        }
        TokenKind::Plus => {
            return crate::parser::statements::primary::operators::parse_pos_expr(parser, span);
        }
        TokenKind::PlusPlus => {
            return crate::parser::statements::primary::operators::parse_pre_inc_expr(parser, span);
        }
        TokenKind::MinusMinus => {
            return crate::parser::statements::primary::operators::parse_pre_dec_expr(parser, span);
        }
